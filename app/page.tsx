  ...
  return (
    <div className={'flex min-h-screen flex-col items-center pt-4'}>
      <div className={'relative flex h-[814px] w-full justify-center rounded-2xl p-6'}>
        ...
        <div className={'container z-20 flex w-full flex-col items-center justify-between pb-20 pt-6 lg:flex-row'}>
          <div className={'flex h-full max-w-[800px] flex-col justify-end'}>
            <div className={'flex flex-col gap-6'}>
              ...
              <p className={'mb-[60px] text-center text-sm text-white lg:text-left lg:text-xl'}>{heroDescription}</p>
            </div>
          </div>
          <div>
            <TradingWidget />
